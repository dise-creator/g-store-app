    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        ...
        <motion.div
          ...
          className="w-8 h-8 border-2 border-[#00d68f] border-t-transparent rounded-full"
        />
      </div>
    );
  }
  ...
  return (
    <main className="relative min-h-screen pt-24 md:pt-32 pb-24">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 md:px-10 overflow-x-hidden">
        <Link
          href="/"
          className="inline-flex items-center gap-2 mb-6 px-4 py-2.5 bg-[#0a1860]/60 hover:bg-white/[0.08] border border-[#00d68f]/40 hover:border-[#00d68f]/30 rounded-2xl transition-all group"
        >
          <ChevronLeft
            size={16}
            className="text-white/40 group-hover:text-[#00d68f] transition-colors"
          />
          <span className="text-white/40 group-hover:text-[#00d68f] transition-colors text-xs font-black uppercase  tracking-widest">
            В магазин
          </span>
        </Link>
        ...
        <div className="lg:hidden mb-4">
          <div className="relative bg-[#0a1860]/60 border border-[#00d68f]/40 rounded-[2rem] p-5 flex items-center gap-4 overflow-hidden">
            ...
            <div className="relative shrink-0">
              ...
              <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#00d68f] rounded-full flex items-center justify-center z-20">
        ...
        <div className="lg:hidden mb-4 overflow-x-auto no-scrollbar">
          <div className="flex gap-2 p-1 bg-[#0a1860]/60 border border-[#00d68f]/40 rounded-2xl w-fit min-w-full">
            {tabs.map((tab) => {
              const Icon = tab.icon;
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          >
            <div className="relative bg-[#0a1860]/60 border border-[#00d68f]/40 rounded-[2rem] p-6 flex flex-col items-center gap-4 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-[#00d68f] rounded-full flex items-center justify-center z-20 shadow-[0_0_10px_rgba(99,243,247,0.5)]">
            ...
            <div className="bg-[#0a1860]/60 border border-[#00d68f]/40 rounded-[2rem] p-3 flex flex-col gap-1">
              {tabs.map((tab, i) => {
                const Icon = tab.icon;
                const isActive = activeTab === tab.id;
                return (
                  <motion.button
                    ...
                    whileHover={{ x: 4 }}
                    whileTap={{ scale: 0.97 }}
                    className={`relative flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all text-left overflow-hidden ${isActive ? "text-[#00d68f]" : "text-white/40 hover:text-white hover:bg-white/5"}`}
                  >
                    {isActive && (
                      <motion.div
                        layoutId="tab-bg"
                        className="absolute inset-0 bg-[#00d68f]/10 border border-[#00d68f]/40 rounded-xl"
                        transition={{
                          type: "spring",
                          damping: 25,
                          stiffness: 300,
                    ...
                    {isActive && (
                      <motion.div
                        layoutId="tab-dot"
                        className="ml-auto w-1.5 h-1.5 rounded-full bg-[#00d68f] relative z-10"
                      />
                    )}
                  </motion.button>
                );
          ...
          <motion.div
            ...
            className="flex-1 bg-[#0a1860]/60 border border-[#00d68f]/40 rounded-[2rem] p-5 md:p-8 min-h-[400px] overflow-hidden"
          >
            <AnimatePresence mode="wait">
              {activeTab === "profile" && (
                ...
                >
                  <h3 className="text-white font-black  uppercase text-xl md:text-2xl mb-5 tracking-tight flex items-center gap-3">
                    <User size={20} className="text-[#00d68f]" /> Мой профиль
                  </h3>
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      <motion.div
                        ...
                        className="flex items-center gap-4 p-4 bg-[#0a1860]/40 hover:bg-white/[0.04] border border-[#00d68f]/30 rounded-2xl transition-all"
                      >
              ...
              {activeTab === "stats" && (
                ...
                >
                  <h3 className="text-white font-black  uppercase text-xl md:text-2xl mb-5 tracking-tight flex items-center gap-3">
                    <BarChart3 size={20} className="text-[#00d68f]" /> Моя
                    статистика
                  </h3>
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    {[
                      ...
                      <motion.div
                        ...
                        transition={{ delay: i * 0.07 }}
                        className="p-4 bg-[#0a1860]/40 border border-[#00d68f]/30 rounded-2xl flex flex-col gap-2"
                      >
                        <div
                        ...
                        {orders
                          ...
                          .map((item, i) => (
                            <motion.div
                              ...
                              className="aspect-square bg-white/5 border border-[#00d68f]/40 rounded-2xl flex items-center justify-center p-2 relative overflow-hidden group"
                            >
              ...
              {activeTab === "orders" && (
                ...
                >
                  <h3 className="text-white font-black  uppercase text-xl md:text-2xl mb-5 tracking-tight flex items-center gap-3">
                    <ShoppingBag size={20} className="text-[#00d68f]" /> Мои
                    заказы
                  </h3>
                  {loadingOrders ? (
                    <div className="flex items-center justify-center h-40">
                      <motion.div
                        ...
                        className="w-6 h-6 border-2 border-[#00d68f] border-t-transparent rounded-full"
                      />
                    </div>
                  ) : orders.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-48 gap-4">
                      ...
                      <Link
                        href="/"
                        className="px-6 py-3 bg-[#00d68f] text-black text-xs font-black uppercase  rounded-2xl"
                      >
                        В магазин
                      </Link>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                      {orders.map((order, i) => (
                        <motion.div
                          ...
                          transition={{ delay: i * 0.07 }}
                          className="p-4 md:p-5 bg-[#0a1860]/40 border border-[#00d68f]/30 rounded-2xl flex flex-col gap-3"
                        >
                          ...
                          <div className="flex flex-col gap-2">
                            {order.items.map((item, j) => (
                              <div
                                key={j}
                                className="flex justify-between items-center py-2 border-t border-[#00d68f]/30"
                              >
                          ...
                          <div className="flex justify-between items-center pt-2 border-t border-[#00d68f]/40">
              ...
              {activeTab === "keys" && (
                ...
                >
                  <h3 className="text-white font-black  uppercase text-xl md:text-2xl mb-5 tracking-tight flex items-center gap-3">
                    <Key size={20} className="text-[#00d68f]" /> Мои ключи
                  </h3>
                  {loadingVouchers ? (
                    <div className="flex items-center justify-center h-40">
                      <motion.div
                    ...
                    <div className="flex flex-col gap-3">
                      {vouchers.map((voucher, i) => (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ delay: i * 0.07 }}
                          className="p-4 bg-[#0a1860]/40 border border-[#00d68f]/30 hover:border-[#00d68f]/40 rounded-2xl flex items-center justify-between gap-3 group transition-all"
                        >
                          <div className="flex flex-col gap-1 min-w-0">
                            <p className="text-white/30 text-[9px] uppercase font-black tracking-widest truncate">
                              {voucher.game_title || "PSN карта"}
                            </p>
                            <p className="text-[#00d68f] font-black text-sm tracking-widest font-mono truncate">
                              {voucher.code}
                            </p>
                            <div className="flex items-center gap-2 mt-1">
                              {voucher.denomination > 0 && (
                                <div className="flex items-center gap-1 px-2 py-0.5 bg-[#00d68f]/10 border border-[#00d68f]/40 rounded-lg">
                                  <CreditCard
                                    size={9}
                                    className="text-[#00d68f]"
                                  />
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            <motion.button
                              ...
                              className={`px-3 py-2 rounded-xl border transition-all text-[10px] font-black uppercase ${
                                activatedId === voucher.id
                                  ...
                                  : "bg-[#0a1860]/60 border-[#00d68f]/40 text-white/30 hover:text-green-400 hover:border-green-400/30"
                              }`}
                            >
                              {activatedId === voucher.id
                                ? "✓ Готово"
                            ...
                            <motion.button
                              ...
                              whileTap={{ scale: 0.9 }}
                              className={`p-3 rounded-xl border transition-all ${copiedId === voucher.id ? "bg-[#00d68f]/10 border-[#00d68f]/30 text-[#00d68f]" : "bg-[#0a1860]/60 border-[#00d68f]/40 text-white/30 hover:text-white"}`}
                            >
                              {copiedId === voucher.id ? (
                                <Check size={16} />
                              ) : (
              ...
              {activeTab === "achievements" && (
                ...
                >
                  <h3 className="text-white font-black  uppercase text-xl md:text-2xl mb-2 tracking-tight flex items-center gap-3">
                    <Trophy size={20} className="text-[#00d68f]" /> Достижения
                  </h3>
                    ...
                    {ACHIEVEMENTS.map((ach, i) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`p-4 rounded-2xl border flex items-center gap-3 transition-all ${unlocked ? "border-[#00d68f]/40 bg-[#00d68f]/5" : "border-[#00d68f]/30 bg-white/[0.01] opacity-40"}`}
                        >
                          <div
                          ...
                          {unlocked && (
                            <div className="ml-auto shrink-0">
                              <div className="w-6 h-6 rounded-full bg-[#00d68f] flex items-center justify-center">
              ...
              {activeTab === "bonus" && (
                ...
                >
                  <h3 className="text-white font-black  uppercase text-xl md:text-2xl mb-5 tracking-tight flex items-center gap-3">
                    <Gift size={20} className="text-[#00d68f]" /> Программа
                    лояльности
                  </h3>
                  <div className="flex flex-col gap-4">
                    <div
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="p-4 bg-[#0a1860]/40 border border-[#00d68f]/30 rounded-2xl">
                    ...
                    {loyalty.nextLevel && (
                      <div className="p-4 bg-[#0a1860]/40 border border-[#00d68f]/30 rounded-2xl flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {[
                        ...
                        <div
                          key={l.level}
                          className={`flex items-center justify-between p-3 rounded-xl border transition-all ${loyalty.level === l.level ? "border-white/20 bg-white/[0.05]" : "border-[#00d68f]/30 bg-white/[0.01]"}`}
                        >
                          <div className="flex items-center gap-2">
                            ...
                            {loyalty.level === l.level && (
                              <span className="text-[8px] bg-[#00d68f]/10 border border-[#00d68f]/40 text-[#00d68f] px-1.5 py-0.5 rounded-lg font-black uppercase">
                                текущий
                              </span>
                            )}
                          </div>
                          <div className="flex items-center gap-3">
                            ...
                            <span
                              className={`text-xs font-black ${loyalty.level === l.level ? "text-[#00d68f]" : "text-white/20"}`}
                            >
                              −{l.discount}
                            </span>
                          </div>
              ...
              {activeTab === "referral" && (
                ...
                >
                  <h3 className="text-white font-black  uppercase text-xl md:text-2xl mb-5 tracking-tight flex items-center gap-3">
                    <Users size={20} className="text-[#00d68f]" /> Пригласи
                    друга
                  </h3>
                  <div className="flex flex-col gap-4">
                    <div className="relative p-6 rounded-2xl overflow-hidden bg-gradient-to-br from-[#00d68f]/10 to-[#a855f7]/10 border border-[#00d68f]/40">
                      <motion.div
                        animate={{ x: ["-100%", "200%"] }}
                        transition={{
                          duration: 3,
                    ...
                    <div className="p-5 bg-[#0a1860]/40 border border-[#00d68f]/30 rounded-2xl flex flex-col gap-3">
                      <p className="text-white/30 text-[10px] uppercase font-black tracking-widest">
                        Твоя реферальная ссылка
                      </p>
                      <div className="flex gap-2">
                        <div className="flex-1 px-4 py-3 bg-white/5 border border-[#00d68f]/40 rounded-2xl font-mono text-xs text-white/50 truncate">
                          {refLink}
                        </div>
                        <motion.button
                          onClick={handleCopyRef}
                          whileTap={{ scale: 0.9 }}
                          className={`px-4 py-3 rounded-2xl border font-black text-xs uppercase transition-all ${copiedRef ? "bg-[#00d68f]/10 border-[#00d68f]/30 text-[#00d68f]" : "bg-white/5 border-[#00d68f]/40 text-white/40 hover:text-white"}`}
                        >
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {[
                        ...
                        <motion.div
                          ...
                          className="flex items-center gap-3 p-3 bg-[#0a1860]/40 border border-[#00d68f]/30 rounded-2xl"
                        >
