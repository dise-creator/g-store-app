  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#050505]">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-[440px] px-8 py-16 bg-black/60 backdrop-blur-3xl border border-[#ff6b00]/40 rounded-[4rem] shadow-[0_0_100px_rgba(255,107,0,0.1)]"
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-5 bg-[#ff6b00] text-black font-black uppercase  text-sm rounded-2xl disabled:opacity-50 transition-all hover:shadow-[0_0_20px_rgba(99,243,247,0.3)]"
          >
