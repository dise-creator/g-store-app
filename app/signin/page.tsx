...
export default function SignInPage() {
  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#050505] py-10">
      ...
      <Link
        href="/"
        className="absolute top-6 right-6 p-3 bg-white/5 hover:bg-white/10 rounded-full border border-white/10 transition-all z-50 group"
      >
        <X
          size={20}
      ...
      <div className="relative z-10 w-full max-w-[900px] mx-4 flex flex-col md:flex-row gap-6">
        ...
        >
              ...
              >
                {tab === "register" && (
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-4 bg-white/[0.04] border border-white/10 focus:border-[#00d68f]/40 rounded-2xl text-white font-bold text-sm outline-none transition-all placeholder-white/20"
                    />
                  </div>
                )}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Пароль"
                    className="w-full pl-10 pr-10 py-4 bg-white/[0.04] border border-white/10 focus:border-[#00d68f]/40 rounded-2xl text-white font-bold text-sm outline-none transition-all placeholder-white/20"
                  />
                  <button
          ...
          <p className="mt-6 text-center text-[8px] text-white/10 uppercase font-bold tracking-[0.2em]">
            Нажмите{" "}
            <span className="text-white/20 border border-white/10 px-2 py-0.5 rounded mx-1">
              ESC
            </span>{" "}
            для отмены
          </p>
