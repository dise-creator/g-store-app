      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 pt-32">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex gap-2">
            <button className="swiper-prev-btn w-11 h-11 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#a855f7] transition-all disabled:opacity-20 cursor-pointer z-20">
              <ChevronLeft className="w-6 h-6 text-white" />
            </button>
            <button className="swiper-next-btn w-11 h-11 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#a855f7] transition-all disabled:opacity-20 cursor-pointer z-20">
