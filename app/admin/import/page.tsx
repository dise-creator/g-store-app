        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h1 className="text-3xl font-black uppercase text-white tracking-tighter">
              Импорт <span className="text-[#ff6b00]">игр</span>
            </h1>
        ...
        <div className="flex gap-3 mb-8">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-5 py-4 bg-[#0a1860]/60 border border-[#ff6b00]/40 rounded-2xl text-white placeholder-white/20 font-bold text-sm focus:outline-none focus:border-[#ff6b00]/40 transition-all"
            />
          </div>
          <button
            onClick={search}
            ...
            >
              {results.map((game, i) => {
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-[#ff6b00]/30 bg-[#0a1860]/40">
                      ...
                      {isAdded && (
                        <div className="absolute inset-0 bg-[#ff6b00]/20 flex items-center justify-center">
                          <Check size={32} className="text-[#ff6b00]" />
                        </div>
                      )}
                    </div>
                    ...
                    <button
                      ...
                      className={`w-full py-2.5 rounded-xl font-black text-[10px] uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 ${
                        isAdded
                          ? "bg-[#ff6b00]/10 border border-[#ff6b00]/40 text-[#ff6b00] cursor-default"
                          : isAdding
                            ? "bg-white/5 border border-[#ff6b00]/40 text-white/30 cursor-wait"
                            : "bg-[#ff6b00] text-black hover:shadow-[0_0_15px_rgba(99,243,247,0.3)] active:scale-95"
                      }`}
                    >
                      {isAdded ? (
                        <>
