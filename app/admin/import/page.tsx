      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex gap-3 mb-8">
          ...
          <button
            onClick={search}
            disabled={loading}
            className="px-8 py-4 bg-[#63f3f7] text-black font-black text-sm uppercase rounded-2xl hover:shadow-[0_0_20px_rgba(99,243,247,0.3)] transition-all active:scale-95 disabled:opacity-50 flex items-center gap-2"
          >
              ...
              {results.map((game, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-white/80 text-[10px] font-black uppercase truncate">{game.name}</p>
                    ...
                    >
                      {isAdded ? <><Check size={12} /> Добавлено</>
                      : isAdding ? <><Loader2 size={12} className="animate-spin" /> Добавляем...</>
