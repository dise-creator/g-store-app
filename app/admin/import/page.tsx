        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h1 className="text-3xl font-black uppercase text-white tracking-tighter">
              Импорт <span className="text-[#f5a623]">игр</span>
            </h1>
        ...
        <div className="flex gap-3 mb-8">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-5 py-4 bg-[#0a1860]/60 border border-[#f5a623]/40 rounded-2xl text-white placeholder-white/20 font-bold text-sm focus:outline-none focus:border-[#f5a623]/40 transition-all"
            />
          </div>
          <button
            onClick={search}
            disabled={loading}
            className="px-8 py-4 bg-[#f5a623] text-black font-black text-sm uppercase rounded-2xl hover:shadow-[0_0_20px_rgba(99,243,247,0.3)] transition-all active:scale-95 disabled:opacity-50 flex items-center gap-2"
          >
            {loading ? (
            ...
            >
              {results.map((game, i) => {
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-[#f5a623]/30 bg-[#0a1860]/40">
                    ...
                    <input
                      ...
                      placeholder="Цена ₽"
                      className="w-full px-3 py-2 bg-[#0a1860]/60 border border-[#f5a623]/40 rounded-xl text-white text-xs font-bold focus:outline-none focus:border-[#f5a623]/40 transition-all placeholder-white/20"
                    />
                    ...
                    <button
                      ...
                      className={`w-full py-2.5 rounded-xl font-black text-[10px] uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 ${
                        isAdded
                          ? "bg-[#f5a623]/10 border border-[#f5a623]/40 text-[#f5a623] cursor-default"
                          : isAdding
                            ? "bg-white/5 border border-[#f5a623]/40 text-white/30 cursor-wait"
                            : "bg-[#f5a623] text-black hover:shadow-[0_0_15px_rgba(99,243,247,0.3)] active:scale-95"
                      }`}
                    >
                      {isAdded ? (
                        <>
