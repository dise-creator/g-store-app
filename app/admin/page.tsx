...
const SECTIONS = [
  { href: "/admin/keys", icon: Key, title: "Ключи", desc: "Загрузка и управление ваучерами PSN", color: "#63f3f7" },
    ...
    <main className="min-h-screen pt-16 pb-20 px-6">
      <div className="max-w-[800px] mx-auto">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mt-6">
          <Link href="/" className="flex items-center justify-center gap-2 py-4 bg-white/[0.02] border border-white/5 text-white/30 hover:text-white rounded-[2rem] font-black text-xs uppercase transition-all">
            ← На главную
          </Link>
        </motion.div>
      </div>
