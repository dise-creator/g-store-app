...
import {
  Key, BarChart3, Upload, Newspaper, Tag, ShieldX, Gamepad2
} from "lucide-react";
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        >
          <h1 className="text-4xl font-black italic uppercase tracking-tighter text-white">
            АДМИН <span className="text-[#63f3f7]">ПАНЕЛЬ</span>
          </h1>
            ...
            return (
              ...
              >
                <Link href={section.href}
                  className="group flex items-center gap-4 p-5 bg-white/[0.03] hover:bg-white/[0.06] border border-white/10 hover:border-white/20 rounded-[2rem] transition-all">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-white font-black uppercase italic text-base tracking-tight">{section.title}</p>
        ...
        >
          <Link href="/"
            className="flex items-center justify-center gap-2 py-4 bg-white/[0.02] border border-white/5 text-white/30 hover:text-white rounded-[2rem] font-black text-xs uppercase italic transition-all">
            ← На главную
          </Link>
        </motion.div>
