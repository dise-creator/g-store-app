        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h1 className="text-3xl font-black uppercase text-white tracking-tighter">
              Анали<span className="text-[#ff6b00]">тика</span>
            </h1>
                  ...
                  <div className="flex flex-col gap-3">
                    {topGames.map((g, i) => (
                      <div key={g.title} className="flex items-center gap-3">
                        <span className="text-[#ff6b00] font-black text-sm w-5">
                          {i + 1}
                        </span>
                        ...
                        <p className="text-[#ff6b00] font-black text-sm shrink-0">
                ...
                {promos.length === 0 ? (
                  ...
                  <div className="flex flex-col gap-3 max-h-[260px] overflow-y-auto pr-1">
                    {promos.map((p) => (
                      <div
                        key={p.id}
                        className={`flex items-center justify-between gap-2 p-3 rounded-2xl border ${p.is_active ? "border-[#ff6b00]/10 bg-[#ff6b00]/[0.02]" : "border-[#ff6b00]/30 opacity-40"}`}
                      >
                        <div>
                        ...
                        <span
                          className={`text-[9px] px-2 py-1 rounded-lg font-black uppercase border ${p.is_active ? "bg-[#ff6b00]/10 border-[#ff6b00]/40 text-[#ff6b00]" : "bg-white/5 border-[#ff6b00]/40 text-white/30"}`}
                        >
              ...
              {orders.length === 0 ? (
                ...
                <div className="flex flex-col gap-2">
                  {orders.slice(0, 10).map((o) => (
                    <div
                      key={o.id}
                      className="flex items-center justify-between gap-4 p-3 bg-[#0a1860]/40 border border-[#ff6b00]/30 rounded-2xl"
                    >
