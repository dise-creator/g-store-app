...
export default function SubscriptionCard({
  ...
  return (
    <button
      onClick={handleAdd}
      className="group relative overflow-hidden rounded-[2.5rem] bg-white/5 border border-[#00d68f]/30 p-8 transition-all hover:scale-[1.02] active:scale-95 cursor-pointer text-left w-full"
    >
      <div
      ...
      <div className="relative z-10 flex flex-col gap-6">
        <div className="flex justify-between items-start">
          ...
          <div className="bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full flex items-center gap-2 border border-[#00d68f]/40">
