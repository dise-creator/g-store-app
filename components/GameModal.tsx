      ...
      >
        ...
        <div className="relative w-full md:w-[48%] h-[28vh] md:h-full group bg-[#060b16] shrink-0">
          ...
          {screenshots.length > 1 && (
            <>
              <button onClick={prevSlide} className="absolute left-3 top-1/2 -translate-y-1/2 w-9 h-9 bg-black/50 backdrop-blur-xl border border-white/10 rounded-full text-white flex items-center justify-center transition-all hover:bg-[#63f3f7] hover:text-black">
                <ChevronLeft size={18} />
              </button>
              <button onClick={nextSlide} className="absolute right-3 top-1/2 -translate-y-1/2 w-9 h-9 bg-black/50 backdrop-blur-xl border border-white/10 rounded-full text-white flex items-center justify-center transition-all hover:bg-[#63f3f7] hover:text-black">
        ...
        <div className="flex flex-col flex-1 overflow-y-auto no-scrollbar bg-[#0a0f1e]">
          <div className="flex flex-col flex-1 p-4 md:p-10 gap-3 md:gap-5 pb-0">
            ...
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
              ...
              <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-white/5 rounded-xl border border-white/5 shrink-0">
              ...
              <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-[#63f3f7]/10 border border-[#63f3f7]/20 rounded-xl shrink-0">
                <span className="text-sm">{currentRegion.flag}</span>
                <span className="text-[9px] text-[#63f3f7] uppercase font-black tracking-widest">{currentRegion.name}</span>
              </div>
            </div>
            ...
            <div className="md:hidden flex flex-col gap-2">
              <p className="text-white/50 text-sm leading-relaxed">{selectedGame?.shortDescription}</p>
              {selectedGame?.fullDescription && (
                <p className="text-white/25 text-xs leading-relaxed line-clamp-4">{selectedGame?.fullDescription}</p>
              )}
            </div>
