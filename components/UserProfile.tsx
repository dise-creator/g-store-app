      ...
      <motion.button
        ...
        className={`relative p-3 rounded-2xl border transition-all overflow-hidden ${
          isOpen && session
            ...
            : "bg-white/5 border-[#ff6b00]/30 hover:bg-white/10 hover:border-[#a855f7]/20"
        }`}
      >
        <AnimatePresence>
          {isOpen && session && (
            ...
            >
              ...
              <div className="relative p-6 flex flex-col gap-4">
                ...
                <motion.div
                  ...
                  className="flex items-center gap-4 pb-5 border-b border-[#ff6b00]/30"
                >
                ...
                >
                  <motion.button
                    ...
                    whileHover={{ x: 4 }}
                    whileTap={{ scale: 0.97 }}
                    className="w-full py-4 px-5 bg-[#0a1860]/60 hover:bg-[#a855f7]/10 border border-[#ff6b00]/30 hover:border-[#a855f7]/30 text-white/60 hover:text-[#a855f7] rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all flex items-center gap-3 group"
                  >
                    <div className="w-7 h-7 rounded-xl bg-white/5 group-hover:bg-[#a855f7]/20 border border-[#ff6b00]/30 group-hover:border-[#a855f7]/30 flex items-center justify-center transition-all">
                      <Sparkles
                        size={13}
