      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-8 left-1/2 -translate-x-1/2 z-[160] w-full max-w-[900px] mx-auto bg-[#0d1f6e] border border-[#00d68f]/40 rounded-[2.5rem] overflow-hidden flex flex-col"
            style={{
              maxHeight: "85vh",
              boxShadow:
          ...
          >
            {/* Строка поиска */}
            <div className="flex items-center gap-4 p-6 border-b border-[#00d68f]/30 shrink-0">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-[#00d68f]/40 focus:border-[#00d68f]/40 rounded-2xl py-4 pl-12 pr-4 text-white text-base outline-none transition-all font-bold tracking-tight placeholder:text-white/20"
                />
              </div>
              <button
                onClick={onClose}
                className="w-12 h-12 rounded-2xl bg-white/5 border border-[#00d68f]/40 flex items-center justify-center text-white/30 hover:text-white hover:bg-white/10 transition-all text-[10px] font-black uppercase shrink-0"
              >
                ESC
              </button>
            </div>
                      ...
                      {searchResults.map((game, i) => {
                        ...
                        return (
                          <motion.div
                            ...
                            className="flex items-center justify-between bg-[#0a1860]/60 hover:bg-white/[0.06] border border-[#00d68f]/30 hover:border-[#00d68f]/40 rounded-2xl p-4 transition-all group cursor-pointer"
                            onClick={() => handleGameClick(game)}
                          >
                            <div className="flex items-center gap-4">
                              <div className="w-20 h-24 relative rounded-2xl overflow-hidden border border-[#00d68f]/40 shrink-0 shadow-lg">
                                <Image
                                  src={game.image}
                                  alt={game.title}
                                  fill
                              ...
                              <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                  <p className="text-[#00d68f] text-lg font-black leading-none">
                            ...
                            <motion.button
                              ...
                              className={`shrink-0 flex items-center gap-2 px-5 py-3 rounded-2xl text-xs font-black uppercase transition-all ${
                                added
                                  ...
                                  : "bg-white/5 text-white/40 border border-[#00d68f]/40 hover:bg-[#00d68f]/10 hover:text-[#00d68f] hover:border-[#00d68f]/30"
                              }`}
                            >
                              {added ? (
                                <Check size={14} />
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
                      {popularGames.map((game) => {
                        ...
                        return (
                          ...
                          >
                            <div className="relative aspect-[3/4] w-full rounded-2xl overflow-hidden border border-[#00d68f]/30 group-hover:border-[#00d68f]/30 transition-all bg-[#161618] shadow-lg group-hover:shadow-[0_8px_20px_rgba(0,0,0,0.4)]">
                              <Image
                                src={game.image}
                                alt={game.title}
                                fill
                            ...
                            <div className="px-0.5">
                              ...
                              <p className="text-[#00d68f] text-[10px] font-black mt-0.5">
                                {displayPrice.toLocaleString()} ₽
                              </p>
                            </div>
                          </motion.button>
