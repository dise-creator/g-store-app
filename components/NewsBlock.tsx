    ...
    >
      <div className="relative h-64 overflow-hidden">
        <Image
          ...
          unoptimized
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1d3a9e] via-[#1d3a9e]/20 to-transparent" />
        <div
          ...
          <div className="mt-auto pt-4 border-t border-white/5 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#00d68f] text-base font-black">
    ...
    <section className="w-full py-2">
      <div className="max-w-[1620px] mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/news"
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/[0.03] border border-white/10 text-white/40 hover:text-[#00d68f] hover:border-[#00d68f]/30 transition-all text-[10px] font-black uppercase tracking-widest"
          >
            Все новости
            <ArrowRight size={14} />
          </Link>
