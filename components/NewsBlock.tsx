  ...
  return (
    <button
      ...
      className={`shrink-0 flex items-center gap-2 px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all ${
        added ? "bg-[#ff6b00] text-black" : "bg-white/5 border border-[#ff6b00]/40 text-white/50 hover:bg-[#ff6b00]/10 hover:text-[#ff6b00]"
      }`}
    >
    ...
    >
      ...
      <div className="flex flex-col p-6 gap-4 shrink-0">
        ...
        {linkedGame && displayPrice !== null && (
          <div className="pt-4 border-t border-[#ff6b00]/15 flex items-center justify-between gap-3">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-4 gap-2 min-w-0 justify-center">
        ...
        {linkedGame && displayPrice !== null && (
          <div className="flex items-center justify-between gap-2 mt-2 pt-2 border-t border-[#ff6b00]/10">
