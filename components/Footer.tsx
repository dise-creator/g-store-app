      ...
      >
        <div className="flex items-center justify-between px-8 py-6 border-b border-[#ff6b00]/30">
          ...
          <motion.button
            onClick={onClose}
            whileTap={{ scale: 0.9 }}
            className="w-10 h-10 rounded-xl bg-white/5 hover:bg-red-500/10 border border-[#ff6b00]/40 hover:border-red-500/20 flex items-center justify-center text-white/30 hover:text-red-400 transition-all"
          >
            <X size={18} />
          </motion.button>
        </div>
  ...
  return (
    <>
      ...
      <footer className="relative z-20 w-full px-4 md:px-8 pb-8 mt-10">
        <div className="max-w-[1420px] mx-auto bg-[#0a1860]/60 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 border border-[#ff6b00]/40 shadow-2xl">
          <div className="flex flex-col md:flex-row justify-between gap-10">
            {/* Лого + описание */}
            <div className="flex flex-col gap-4 max-w-[280px]">
              <div className="flex items-center skew-x-[-12deg]">
                <span
                  className="font-michroma text-white text-2xl font-black"
                  style={{ WebkitTextStroke: "1px white" }}
                >
                  CL
                </span>
                <span
                  className="font-unbounded text-white text-4xl font-black"
                  style={{
              ...
              <p className="text-white/30 text-xs leading-relaxed font-medium">
                Магазин карт пополнения PlayStation Network. Моментальная
                доставка ключей на почту.
              </p>
              ...
              <nav className="flex flex-col gap-3">
                {NAV_LINKS.map((item) => (
                  <button
                    ...
                    className="text-white/40 hover:text-[#ff6b00] transition-colors text-xs font-black uppercase tracking-widest text-left"
                  >
                    {item.label}
                  </button>
                ))}
                ...
                {REGIONS.map((r) => (
                  <div key={r.name} className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#ff6b00] text-[9px] font-black">
                        скидка {r.discount}
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 bg-white/5 hover:bg-[#229ed9] border border-[#ff6b00]/40 text-white rounded-2xl flex items-center justify-center transition-all hover:scale-110 hover:shadow-[0_0_20px_rgba(34,158,217,0.3)]"
                >
              ...
              <div className="mt-2 p-3 bg-[#ff6b00]/5 border border-[#ff6b00]/10 rounded-2xl">
          ...
          {/* Нижняя строка */}
          <div className="mt-10 pt-6 border-t border-[#ff6b00]/30 flex flex-col md:flex-row justify-between items-center gap-4">
