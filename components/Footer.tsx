  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-2xl bg-[#0d1f6e] border border-[#00d68f]/20 rounded-[2rem] overflow-hidden shadow-2xl"
        style={{ boxShadow: "0 0 60px rgba(0,60,160,0.2)" }}
      >
        <div className="flex items-center justify-between px-8 py-6 border-b border-[#00d68f]/15">
          ...
          <motion.button
            onClick={onClose}
            whileTap={{ scale: 0.9 }}
            className="w-10 h-10 rounded-xl bg-white/5 hover:bg-red-500/10 border border-[#00d68f]/20 hover:border-red-500/20 flex items-center justify-center text-white/30 hover:text-red-400 transition-all"
          >
            <X size={18} />
          </motion.button>
        </div>
  ...
  return (
    <>
      ...
      <footer className="relative z-20 w-full px-4 md:px-8 pb-8 mt-10">
        <div className="max-w-[1420px] mx-auto bg-white/[0.03] backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 border border-[#00d68f]/20 shadow-2xl">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 bg-white/5 hover:bg-[#229ed9] border border-[#00d68f]/20 text-white rounded-2xl flex items-center justify-center transition-all hover:scale-110 hover:shadow-[0_0_20px_rgba(34,158,217,0.3)]"
                >
          ...
          {/* Нижняя строка */}
          <div className="mt-10 pt-6 border-t border-[#00d68f]/15 flex flex-col md:flex-row justify-between items-center gap-4">
