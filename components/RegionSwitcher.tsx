...
export default function RegionSwitcher() {
  ...
  return (
    <div ref={ref} className="relative">
      {/* Десктоп */}
      <div className="hidden md:flex items-center gap-1.5 p-1 bg-white/[0.03] border border-[#00d68f]/15 rounded-2xl">
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute top-[calc(100%+8px)] left-0 z-[200] min-w-[160px] bg-[#0d1f6e] border border-[#00d68f]/20 rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)]"
            >
