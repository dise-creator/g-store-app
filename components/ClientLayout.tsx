...
function RatesLoader() {
  ...
  return (
    <div className="fixed bottom-24 left-6 z-[500] flex items-center gap-2 px-4 py-2.5 bg-[#0a0a0b] border border-[#ff6b00]/40 rounded-2xl shadow-2xl backdrop-blur-xl md:bottom-6">
